...
<template>
  ...
  >
    <span class="navitem__icon" aria-hidden="true">
      <!-- Dashboard -->
      <svg v-if="icon === 'dashboard'" width="24" height="24" viewBox="0 0 20 20" fill="none">
      ...
      <!-- Money -->
      <svg v-else-if="icon === 'money'" width="24" height="24" viewBox="0 0 20 20" fill="none">
      ...
      <!-- Tasks -->
      <svg v-else-if="icon === 'tasks'" width="24" height="24" viewBox="0 0 20 20" fill="none">
        <rect x="3" y="3" width="14" height="14" rx="2" stroke="currentColor" stroke-width="1.5" />
        <path d="M7 10L9 12L13 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
      <!-- Shopping -->
      <svg v-else-if="icon === 'shopping'" width="24" height="24" viewBox="0 0 20 20" fill="none">
      ...
      <!-- Inventory -->
      <svg v-else-if="icon === 'inventory'" width="24" height="24" viewBox="0 0 20 20" fill="none">
      ...
      <!-- Reminders -->
      <svg v-else-if="icon === 'reminders'" width="24" height="24" viewBox="0 0 20 20" fill="none">
        <circle cx="10" cy="10" r="7" stroke="currentColor" stroke-width="1.5" />
        <path d="M10 6V10L13 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
      </svg>
      <!-- Notes -->
      <svg v-else-if="icon === 'notes'" width="24" height="24" viewBox="0 0 20 20" fill="none">
      ...
      <!-- Maintenance -->
      <svg v-else-if="icon === 'maintenance'" width="24" height="24" viewBox="0 0 20 20" fill="none">
      ...
      <!-- Settings -->
      <svg v-else-if="icon === 'settings'" width="24" height="24" viewBox="0 0 20 20" fill="none">
...
.navitem--active::before {
  ...
  bottom: 6px;
  width: 2px;
  background: var(--color-nav-brand-indicator);
